...
$sql = "SELECT id, phrase, translation, audioChinese, audioEnglish FROM chinesephrase WHERE translation LIKE '%$text%' OR phrase LIKE '%$text%'";
...
echo 				"<source src=\"{$engAudio}\" type=\"audio/mp4\" />\n";
echo 			"</td>\n";
