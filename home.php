...
<p class="infoText">If you've made it to this page, it's because you're interested in brushing up on your Chinese terminology. 
...
that's your thing). Once you've mastered our auto generated list of topics, feel free to add your own to keep on learning at your own pace.
	...
	<p class="userText" style="text-align:center;">Already a user?<a href="login.html"><img class="login" src="login.png" /></a></p>
	<p class="userText" style="text-align:center;">Are you a new user?<a href="register.html"><img class="register" src="register.png" /></a></p>
	</div>

	<div style="margin-left:425px; margin-bottom:100px">
